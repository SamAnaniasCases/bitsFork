                        ...
                        <div className="p-6 space-y-4 overflow-y-auto">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input
                                        type="number" min={0} max={180} placeholder="60"
                            ...
                            {(form.startTime && form.endTime) && (
                                <div className="bg-red-50 border border-red-100 rounded-xl p-3 flex items-center gap-3">
                                    ...
                                    <div className="text-xs text-red-700 font-bold">
                                        ...
                                        <span className="text-red-400 font-medium ml-2">({calcDuration(form.startTime, form.endTime, form.isNightShift)} total · {form.breakMinutes}m break)</span>
                                    </div>
                                </div>
                            )}
                        </div>
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex items-center gap-1 text-[10px] font-bold text-slate-500">
                                            <Coffee size={11} className="text-slate-400" />{s.breakMinutes}m break
                                        </div>
                                    </div>
                                </td>
                                <td className="px-6 py-4">
